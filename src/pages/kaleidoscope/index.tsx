...
export default function KaleidoscopePage() {
  return (
    <>
      <Head>
        <title>Kaleidoscope Recovery - A Radical Recovery Solution</title>
        <meta name="description" content="A radical recovery solution for those ready to be free from drinking and the pain beneath it. Kaleidoscope delivers complete personal transformation for alcoholics and their loved ones." />
